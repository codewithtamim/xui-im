...
update() {
    ...
    bash <(curl -Ls https://raw.githubusercontent.com/codewithtamim/xui-im/main/update.sh)
    if [[ $? == 0 ]]; then
...
update_menu() {
    ...
    curl -fLRo /usr/bin/x-ui https://raw.githubusercontent.com/codewithtamim/xui-im/main/x-ui.sh
...
legacy_version() {
    ...
    install_command="bash <(curl -Ls "https://raw.githubusercontent.com/codewithtamim/xui-im/v$tag_version/install.sh") v$tag_version"
...
uninstall() {
    ...
    echo -e "${green}bash <(curl -Ls https://raw.githubusercontent.com/codewithtamim/xui-im/master/install.sh)${plain}"
    echo ""
...
update_shell() {
    curl -fLRo /usr/bin/x-ui -z /usr/bin/x-ui https://github.com/codewithtamim/xui-im/raw/main/x-ui.sh
    if [[ $? != 0 ]]; then
        echo ""
