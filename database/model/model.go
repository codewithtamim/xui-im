// Package model defines the database models and data structures used by the xui-im panel.
package model
...
// User represents a user account in the xui-im panel.
type User struct {
...
// Setting stores key-value configuration settings for the xui-im panel.
type Setting struct {
	Id    int    `json:"id" form:"id" gorm:"primaryKey;autoIncrement"`
