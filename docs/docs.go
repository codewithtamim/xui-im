...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/panel/api/inbounds/addClientWithConfig": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/controller.createApiKeyForm"
                        }
                    }
                ],
                "responses": {
        ...
        "/panel/setting/apikeys/delete/{id}": {
            "post": {
                "produces": [
                    "application/json"
                ],
        ...
        "/panel/setting/apikeys/toggle/{id}": {
            "post": {
                "produces": [
                    "application/json"
                ],
