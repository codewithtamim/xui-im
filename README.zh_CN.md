...
本项目是 [MHSanaei/3x-ui](https://github.com/MHSanaei/3x-ui) 的分支。特别感谢：

- [MHSanaei](https://github.com/MHSanaei) — 3X-UI 的原始创建者和维护者
- [alireza0](https://github.com/alireza0/) — 原始项目的主要贡献者
