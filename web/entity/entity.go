// Package entity defines data structures and entities used by the web layer of the xui-im panel.
package entity
...
// AllSetting contains all configuration settings for the xui-im panel including web server, Telegram bot, and subscription settings.
